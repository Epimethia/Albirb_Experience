...
#define ORIGINAL_FILE_NAME "UE4Editor-ALBIRB_EXPERIENCE.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ALBIRB_EXPERIENCE
#define DEPRECATED_FORGAME DEPRECATED
#define ALBIRB_EXPERIENCE_API DLLEXPORT
